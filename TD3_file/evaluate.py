...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder_name", type=str, default="TD3_1") # 模型文件夹名 model名 + trick名
    # 种子和评估次数设置
    ...
    policy = TD3.load(dim_info,is_continue = is_continue ,model_dir=model_dir,trick = args.trick,realize= args.realize)
    ...
    # save gif
    if args.save_gif:
        render(args.env_name,policy,model_dir)
