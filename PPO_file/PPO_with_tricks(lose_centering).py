    ...
    def learn(self, minibatch_size, gamma, lmbda ,clip_param, K_epochs, entropy_coefficient):
        ...
        with torch.no_grad():  # adv and v_target have no gradient
            ...
            if self.trick['reward_centering']:
                ...
                self.avg_reward +=  avg_rew_delta.mean() # avg_rew_delta
                #print(self.beta)
                ## re compute td_delta  
                target += (old_avg_reward - self.avg_reward)
                td_delta = target - vs
