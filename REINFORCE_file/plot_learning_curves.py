...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_name", type=str, default="CartPole-v1") # /results/env_name
    ...
    parser.add_argument("--seed_num", type=int, default=3) #评估的随机种子数 == 已经训练的文件数
    ## 注意：是否比较其他算法
    parser.add_argument("--is_compare", type=str, default=False) # 多个算法比较
    # trick 评估 算法 or 算法 + trick
    parser.add_argument("--policy_name", type=str, default='REINFORCE')  # 算法
    parser.add_argument("--trick", type=dict, default=None) 
    #parser.add_argument("--trick", type=dict, default={'Double':True,'Dueling':True,'PER':True,'Noisy':True,'N_Step':True,'Categorical':True})  # rainbow
