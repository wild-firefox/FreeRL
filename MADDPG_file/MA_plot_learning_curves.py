...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_name", type=str, default="simple_spread_v3") # /results/env_name
    ...
    parser.add_argument("--policy_name", type=str, default='MADDPG')  # 算法 # DDPG_simple
    parser.add_argument("--trick", type=dict, default={'ATT':False}) # MADDPG_simple 算法时有此trick
