...
from SAC_add_discrete import SAC
from SAC_add_discrete import get_env 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder_name", type=str, default="SAC_OUNoise_1") # 模型文件夹名 model名 + trick名
    # 环境参数
    ...
    parser.add_argument("--trick", type=dict, default={'Batch_ObsNorm':False,'ObsNorm':False}) # 可均不用 可用Batch_ObsNorm
    ...
    policy = SAC.load(dim_info,is_continue = is_continue ,model_dir=model_dir,trick = args.trick)
    ...
    for e in range(args.max_episodes):
        ...
        if  args.trick['Batch_ObsNorm'] or args.trick['ObsNorm']:
