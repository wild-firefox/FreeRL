...
from MASAC import MASAC # or from MADDPG_simple_with_tricks import MADDPG
from MASAC import get_env 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder_name", type=str, default="MASAC_1") # 模型文件夹名 model名 + trick名
    # 环境参数
    ...
    parser.add_argument("--supplement", type=dict, default=None) # 
    ...
    policy = MASAC.load(dim_info,is_continue = is_continue ,model_dir=model_dir,)
